...
let CharacterBarComponent = class CharacterBarComponent {
    ...
    initBar() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            var fullTeam = yield _game_game_component__WEBPACK_IMPORTED_MODULE_2__["GameComponent"].characterService.getTeam(this.team);
            for (var i = 0; i < fullTeam.length; i++) {
                let chardata = yield _game_game_component__WEBPACK_IMPORTED_MODULE_2__["GameComponent"].characterService.getCharacter(this.team, fullTeam[i]);
                document.getElementById("character-bar").innerHTML += chardata.html;
            }
            for (var i = 0; i < 8 - fullTeam.length; i++) {
                let unknown = yield _game_game_component__WEBPACK_IMPORTED_MODULE_2__["GameComponent"].characterService.getCharacter("white", "unknown");
...
/* harmony import */ var _characterService__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./characterService */ "./src/app/game/characterService.ts");
/* harmony import */ var _aspnet_signalr__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @aspnet/signalr */ "./node_modules/@aspnet/signalr/dist/esm/index.js");
...
let GameComponent = GameComponent_1 = class GameComponent {
    ...
    ngOnInit() {
        let connection = new _aspnet_signalr__WEBPACK_IMPORTED_MODULE_9__["HubConnectionBuilder"]()
            .withUrl("/gamehub")
            .build();
    ...
    draw_background(connected = true) {
        ...
        if (this.ended != 0 && this.side == this.ended) {
            ...
            if (_app_component__WEBPACK_IMPORTED_MODULE_10__["AppComponent"].user.name != "new_user")
                _app_component__WEBPACK_IMPORTED_MODULE_10__["AppComponent"].user.win(this.id);
        }
    }
};
